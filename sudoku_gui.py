...
def redraw_window(win, board, time, strikes):
    ...
    # Draw time
    fnt = pygame.font.SysFont("comicsans", 40)
    text = fnt.render("Time: " + format_time(time), 0.1, (0,0,0))
    win.blit(text, (600 - 160, 590))
    # Draw Strikes
    text = fnt.render("X " * strikes, 0.1, (255, 0, 0))
